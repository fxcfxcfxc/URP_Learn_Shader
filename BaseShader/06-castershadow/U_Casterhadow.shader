        ...
        SubShader
    {
        ...
        Pass
        {
            ...
            {      
                ...
                //abmient方法
                //float3  ambColor = UNITY_LIGHTMODEL_AMBIENT.xyz * _ambStrength;
                //half3 ambColor = half3(unity_SHAr.w,unity_SHAg.w,unity_SHAb.w) * _ambStrength;
                half3 ambColor = _GlossyEnvironmentColor * _ambStrength ;
