Shader "Unlit/Water"
{
    Properties
    {
        ...
        _RefractionSpeed ("折射扭曲速度", float) = 1.0
        _RefractionScale ("折射扭曲幅度", float) = 1.0
        ...
        _FoamSpeed ("水花扭曲速度", float) = 1.0
        _FoamScale ("水花扭曲幅度", float) = 1.0
        _FoamAmount ("水花深度", float) = 1.0
        _FoamCutoff ("水花清晰程度", float) = 1.0
        ...
        _WaterSpeed ("水面移动速度", float) = 1.0
        _WaterNoiseSize ("水面噪音强度", float) = 1.0
        _WaterStrength ("水面扰动强度", float) = 1.0
        //blend Mode
